'''
9-3: Adding output for debugging 

* Recursion is hard to debug, so having output can help with 
debugging code and determine at what level your program is in recursion. 
'''
